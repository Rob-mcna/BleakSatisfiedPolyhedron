...
function showCreateValveModal() {
  ...
  document.getElementById('createValveForm').onsubmit = async function(e) {
    ...
    try {
      // --- API Call ---
      const response = await fetch("http://http://127.0.0.1:5000/api/valves/", {
        method: "POST",
...
async function showCreateBlockingValveRuleModal() {
  ...
  form.onsubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://http://127.0.0.1:5000/api/cavity_volumes/", {
        method: "POST",
        headers: { 'Content-Type': 'application/json' },
...
async function showCreateChristmasTreeModal() {
  ...
  document.getElementById('createChristmasTreeForm').onsubmit = async function(e) {
    ...
    try {
      const response = await fetch("http://http://127.0.0.1:5000/api/wellheads/", {
        method: "POST",
...
function showCreateWellModal() {
  ...
  fetch("http://http://127.0.0.1:5000/api/wellheads/")
  .then(r => r.json())
  .then(treeTypes => {
  ...
  document.getElementById('createWellForm').onsubmit = async function(e) {
    ...
    await fetch("http://http://127.0.0.1:5000/api/wells/", {
      method: "POST",
      headers: { 'Content-Type': 'application/json' },
