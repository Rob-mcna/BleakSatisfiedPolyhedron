...
function renderDeviationsList() {
  ...
  let html = `
    <table style="width:100%;margin-top:10px;border-collapse: collapse;">
      <thead>
        <tr>
          <th style="text-align:left; padding:8px; border-bottom:1px ;">Type</th>
          <th style="text-align:left; padding:8px; border-bottom:1px ;">Title</th>
          <th style="text-align:left; padding:8px; border-bottom:1px ;">Status</th>
          <th style="text-align:left; padding:8px; border-bottom:1px ;">Valid Until</th>
          <th style="text-align:left; padding:8px; border-bottom:1px ;">Created By</th> <!-- MODIFICATION: Add Created By Column -->
          <th style="text-align:left; padding:8px; border-bottom:1px ;">Actions</th>
        </tr>
      </thead>
      <tbody>`;
  ...
  if (filteredDeviations.length === 0) {
    ...
    filteredDeviations.forEach(dev => {
      html += `<tr>
        <td style="padding:8px; border-bottom:1px ;">${dev.type}</td>
        <td style="padding:8px; border-bottom:1px ;">${dev.title}</td>
        <td style="padding:8px; border-bottom:1px ;">${dev.status}</td>
        <td style="padding:8px; border-bottom:1px ;">${dev.validUntil}</td>
        <td style="padding:8px; border-bottom:1px ;">${dev.createdBy || "N/A"}</td> <!-- MODIFICATION: Display createdBy -->
